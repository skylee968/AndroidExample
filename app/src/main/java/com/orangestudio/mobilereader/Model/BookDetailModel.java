...
import com.orangestudio.mobilereader.Listener.BookDetailIF;
...
public class BookDetailModel extends BaseModel implements BookDetailIF {
	...
	SimpleStoreIF getStoreAdapter() {
		return StoreUtils.getStoreAdapter(DBConfig.Cache.BOOK_DETAIL_TABLE, MRApplicationContext.getContext(),
				DBConfig.Cache.BOOK_DETAIL_TABLE_SIZE);
	}
