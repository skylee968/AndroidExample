...
public final class CommonUtils {
	...
	public static void showToast(String message) {
		Toast.makeText(MRApplicationContext.getContext(), message, Toast.LENGTH_LONG).show();
	}
	...
	public static String getVersionName() {
		try {
			return MRApplicationContext.getContext().getPackageManager().getPackageInfo(MRApplicationContext.getContext().getPackageName(), 0).versionName;
		} catch (Exception e) {
			return null;
		}
	}
	...
	public static void openWebUrl(String url) {
		...
		try {
			...
			MRApplicationContext.getContext().startActivity(launchIntent);
